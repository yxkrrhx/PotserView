...
import com.example.yishuinanfeng.jigsawapplication.util.SoftInputUtil;
...
//                showPicEditBar(pictureModel);
                ...
                SoftInputUtil.getInstance(JigsawActivity.this).showSoftInput(mJigsawView);
            }
        });
        ...
        mJigsawView.setFocusable(true);
        mJigsawView.setFocusableInTouchMode(true);
    }
